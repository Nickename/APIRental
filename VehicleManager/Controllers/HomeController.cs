...
namespace VehicleManager.Controllers
{
    public class HomeController : Controller
    {
        ...
        private readonly IRental rentalRepository;
        private readonly IVehicleCategory categoryRepository;
        private readonly ILogger<HomeController> _logger;

        public HomeController(ICar carRepository, ILogger<HomeController> logger, IRental rentalRepository, IVehicleCategory categoryRepository)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                category.Cars = await carRepository.GetAllAsync($"c=>c.VehicleCategoryId == {category.VehicleCategoryId}");
            }
            return View(indexVM);
        }
        ...
        public async Task<IActionResult> Index(int vehicleCategoryId, DateTime pickupDate, DateTime returnDate)
        {
            ...
            string filter = $"s => s.VehicleCategoryId == {vehicleCategoryId}";
